...
* @brief Library of functions using the CAN interface.
*/
...
/**
* @brief Sends message over the CAN bus that the
easy PID controller shall be used in the game.
*/
void oled_easy_pid(void);

/**
* @brief ends message over the CAN bus that the
hard PID controller shall be used in the game.
*/
void oled_hard_pid(void);

/**
* @brief Checks if there has happened a CAN interrupt.
*/
int check_CAN_interrupt(void);

/**
* @brief Sends the position of the x, y and button values over the Can bus.
*@param [in] x The x-position.
*@param [in] y The y-position.
*@param [in] button The button value.
*/
